...
class DebugTrip
{
    ...
    // Add main method here for testing
    public static void main(String[] args)
    {
        ...
        System.out.println("Trip 1: " + trip1.getDestination() + ", " + trip1.getDepartureCity() + ", " + trip1.getMode());
        System.out.println("Trip 2: " + trip2.getDestination() + ", " + trip2.getDepartureCity() + ", " + trip2.getMode());
        System.out.println("Trip 3: " + trip3.getDestination() + ", " + trip3.getDepartureCity() + ", " + trip3.getMode());
    }
}
